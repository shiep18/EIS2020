#-----获取人脸样本-----
import cv2
pathf="E:\zhu/face/haarcascade_frontalface_default.xml"#脸部识别
#调用笔记本内置摄像头，参数为0，如果有其他的摄像头可以调整参数为1,2
cap = cv2.VideoCapture(0)
#调用人脸分类器，要根据实际路径调整
face_detector = cv2.CascadeClassifier(pathf)  
#为即将录入的脸标记一个id
...
while True:    
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.imwrite("E:\zhu/face/data1/User."+str(face_id)+'.'+str(count)+'.jpg',gray[y:y+h,x:x+w]) 
        #显示图片
