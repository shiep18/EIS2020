...
class mytimercallback():
   ...
   def execute(self,obj,event):
      ...
      if resp !="":
         ...
         self.angle=speeds[2]
         print("左、右、角度",self.leftspeed,self.rightspeed,self.angle)
      self.actors[0].RotateZ(self.leftspeed);
      self.actors_qian[0].RotateZ(self.leftspeed);
      self.actors[1].RotateZ(self.rightspeed);
      self.actors_qian[1].RotateZ(self.rightspeed);
      self.ass[0].RotateX(self.angle)
      iren = obj
...
def main():
   ...
   cb.actors_qian.append(actor4)
   cb.actors_qian.append(actor3)
   cb.ass.append(assembly)
