...
class mytimercallback():
   ...
   def execute(self,obj,event):
      ...
      if resp !="":
         ...
         self.actors[2].RotateX(self.d);
         self.d=speeds[2]-2*speeds[2]
         self.actors[2].RotateX(speeds[2]);
...
def main():
    ...
    renderer.SetBackground(0,1,0)  # RGB 0~1

    actor1.SetOrigin(actor1.GetCenter())
    actor2.SetOrigin(actor2.GetCenter())
    actor3.SetOrigin(actor2.GetCenter())
    actor4.SetOrigin(actor2.GetCenter())
