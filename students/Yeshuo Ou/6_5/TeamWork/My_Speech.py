...
def getBaiduText():
    ...
    print("您好！现在有"+str(num_basketball)+"个篮球,有"+str(num_football)+"个足球，有什么能帮助您的吗？")
    speaker.Speak("您好！现在有"+str(num_basketball)+"个篮球,有"+str(num_football)+"个足球，有什么能帮助您的吗？")
...
def wakeUp(result,pinyin):
    ...
    if (getPinYin("几个") in pinyin or getPinYin("多少") in pinyin or getPinYin("的数量")in pinyin ) and getPinYin("球") in pinyin :
        print("现在有"+str(num_basketball)+"个篮球,有"+str(num_football)+"个足球，您需要什么？")
        speaker.Speak("现在有"+str(num_basketball)+"个篮球,有"+str(num_football)+"个足球，您需要什么？")
