...
actor5.RotateZ(-90)
assembly.RotateZ(-90)
actor1.SetPosition(20,120,0)
actor2.SetPosition(20,120,0)
'''
#actor1.SetOrigin(-195.15599632263184, 90.36652946472158, -12.0)
#actor2.SetOrigin(-195.15599632263184, 90.36652946472158, 111.0)
print("actor1 center:",actor1.GetCenter())
print("actor2 center:",actor2.GetCenter())
