...
#with open("C://Apache24//htdocs//num.html", "r") as f:
#    num = f.read()

light_state_path = "C://Apache24//htdocs//door.html"
...
def setup(hass, config):
    ...
    attr = {"icon": "mdi:yin-yang",
            "friendly_name": "door1",
            "slogon": "Say hello to the camera;",
            "unit_of_measurement": ""}
...
class GrowingState(object):
    ...
    def update(self, now):
        ...
        # _LOGGER.info(num)
        # _LOGGER.info(f"GrowingState is {num}")
