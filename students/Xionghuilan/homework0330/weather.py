...
def getWeatherInfo(city):
    global cond
    key = "f1dfee91047f4c27a9fe52e1496b6bd7"
    ...
    try:
        ...
        return(["今天%s的天气状况：%s，温度：%s℃，体感温度：%s℃，空气质量：%s，风向：%s，风力：%s级，湿度：百分之%s，能见度：%s公里，%s%s%s"%(location,cond,tmp,fl,airBrf,windDir,windSc,hum,vis,flu,drsg,cw)],tmp)
    except:
