...
##        _LOGGER.info("GrowingState is ")
##        with open('C:\\Users\\xiong\\AppData\\Roaming\\.homeassistant\\custom_components\\num.txt') as f:
        
        with open('C:\\Apache24\\htdocs\\index1.html') as f:
          for line in f.readlines():
             _LOGGER.info("GrowingState is %s",line)
##             _LOGGER.info(line)
        ...
        # 设置新的状态值
        self._hass.states.set(ENTITYID, line, attributes=self._attr)
