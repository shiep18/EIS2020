...
BAIDU_APP_ID = '157585469'

BAIDU_API_KEY = 'fdfdsgfhfghfghdfhzhfhzhfb'

BAIDU_SECRET_KEY = 'sdghdfhbfgnhgbngdhtruyjkgfstwe4'
...
white = cv2.imread('cloth1.jpg')

black = cv2.imread('cloth2.jpg')
