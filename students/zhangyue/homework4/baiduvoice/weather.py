...
def getWeatherInfo(city):
    key = "114e7233c227405d9f0e06a28f48fe6a"
    ...
    try:
        ...
        return (["今天%s的天气状况：%s，温度：%s℃，体感温度：%s℃，空气质量：%s，风向：%s，风力：%s级，湿度：百分之%s，能见度：%s公里，%s%s%s" % (
            location, cond, tmp, fl, airBrf, windDir, windSc, hum, vis, flu, drsg, cw)], tmp)
