...
class GrowingState(object):
    ...
    def update(self, now):
        ...
        a=linecache.getline("C:\\Users\\11722\\AppData\\Roaming\\.homeassistant\\custom_components\\Goods\\Goods3.txt",1) #Apache要一直更新
        f.close()
