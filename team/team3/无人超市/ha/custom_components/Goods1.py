...
class GrowingState(object):
    ...
    def update(self, now):
        ...
        a=linecache.getline("C:\\Users\\11722\\AppData\\Roaming\\.homeassistant\\custom_components\\Goods\\Goods1.txt",1) #Apache要一直更新
        f.close()
        ...
        if a !='':
            ...
            _LOGGER.info("GrowingState is "+self._state)
            # 设置新的状态值
            self._hass.states.set(ENTITYID, self._state, attributes=self._attr)
